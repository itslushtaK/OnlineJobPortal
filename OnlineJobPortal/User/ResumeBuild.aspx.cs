...
namespace OnlineJobPortal.User
{
    public partial class ResumeBuild : System.Web.UI.Page
    {
        ...
        private object txtPostGraduation;
        private object ex;
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (Request.QueryString["id"] != null)
                {
                    ...
                    query = @"Update [User] set Username=@Username, Email=@Email, Mobile=@Mobile, 
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "Cannot update the records, please try logging in again!";
                    lblMsg.CssClass = "alert alert-danger";
                }
            }
