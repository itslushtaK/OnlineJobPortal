...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background-image: url('../Images/bg.jpg'); width: 100%; height: 720px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
        <div class="container pt-4 pb-4">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtJobTitle" runat="server" CssClass="form-control"
                        placeholder="Ex. Web Developer , App Developer"></asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    <label for="txtJobTitle" style="font-weight: 600">Nomber Of Post</label>
                    <asp:TextBox ID="txtNoOfPost" runat="server" CssClass="form-control"
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSpecialization" runat="server" CssClass="form-control"
                        placeholder="Enter Specilization" TextMode="MultiLine" required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    <label for="txtLastDate" style="font-weight: 600">Last Date o Apply</label>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control"
                        placeholder="Ex:2500/Month , 100k/Year" required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatori" runat="server" ErrorMessage="Job Type is Required"
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    <label for="txtCompany" style="font-weight: 600">Company/Organization</label>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    <label for="txtWebsite" style="font-weight: 600">Webiste</label>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary brn-block"
